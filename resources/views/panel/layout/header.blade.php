        ...
        <div class="p-0 container-fluid max-lg:w-full">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="primary-nav navbar-nav max-lg:py-4 max-lg:px-3">
					...
					@endif
					<li class="nav-item">
                        <a class="nav-link {{activeRoute('dashboard.user.integrations')}}" href="{{route('dashboard.user.integrations.index')}}" >
							<span class="nav-link-icon">
								<svg class="md:me-2 max-lg:w-[20px] max-lg:h-[20px] ms-1" width="12" height="15" viewBox="0 0 11 15" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        							<path d="M6.6 0L0 9.375H4.4V15L11 5.625H6.6V0Z"></path>
        						</svg>
							</span>
                            <span class="flex items-center transition-[opacity,transform] nav-link-title grow">
								{{__('Integrations')}}
