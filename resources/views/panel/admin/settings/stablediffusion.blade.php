						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="mb-3">
									...
									<select class="form-select" name="stablediffusion_default_model" id="stablediffusion_default_model">
										<option value="stable-diffusion-xl-1024-v0-9" {{$settings_two->stablediffusion_default_model == 'stable-diffusion-xl-1024-v0-9' ? 'selected' : null}}>{{__('Stable Diffusion XL 0.9')}}</option>
										<option value="stable-diffusion-xl-1024-v1-0"{{$settings_two->stablediffusion_default_model == 'stable-diffusion-xl-1024-v1-0' ? 'selected' : null}}>{{__('Stable Diffusion XL 1.0')}}</option>
										<option value="stable-diffusion-v1-5" {{$settings_two->stablediffusion_default_model == 'stable-diffusion-v1-5' ? 'selected' : null}}>{{__('Stable Diffusion 1.5')}}</option>
										<option value="stable-diffusion-512-v2-1" {{$settings_two->stablediffusion_default_model == 'stable-diffusion-512-v2-1' ? 'selected' : null}}>{{__('Stable Diffusion 2.1')}}</option>
									</select>
								</div>
							</div>
{{-- 
